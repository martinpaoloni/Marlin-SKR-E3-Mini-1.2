...
#define SLOWDOWN
#if ENABLED(SLOWDOWN)
  #define SLOWDOWN_DIVISOR 8 // (valor original: 2) https://www.reddit.com/r/ender3/comments/hymv70/marlin_20x_guide_skr_mini_e3_v12_ender_3/
#endif
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g. 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 32 // SD,LCD,Buttons take more memory, block buffer needs to be smaller (valor original: 16)
#else
  #define BLOCK_BUFFER_SIZE 16 32 // maximize block buffer (valor original: 16)
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  // Cambiar a retraction speed. Estaba en 60. Le puse 30 como decia aca, para filament runout sensor. https://www.reddit.com/r/ender3/comments/hymv70/marlin_20x_guide_skr_mini_e3_v12_ender_3/
  #define PAUSE_PARK_RETRACT_FEEDRATE         30  // (mm/s) Initial retract feedrate.
  // Idem. Cambiado de 2 a 6.
  #define PAUSE_PARK_RETRACT_LENGTH            6  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     10  // (mm/s) Unload filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  // Cambiado de 100 a 600 mm.
 ...
 */
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  50 // (valor original 8)
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  50 // (valor original 8)
